...
export function LoginForm({
  ...
  return (
    // Khung tràn viền, panel CĂN GIỮA DỌC bên phải (thiết kế cuối: `top:50%
    // translateY(-50%); right:64px`) — căn bằng flexbox thay vì absolute để khi các bảng
    // phụ (mã mời, mở khoá) bung ra làm panel cao hơn màn, trang còn cuộn được.
    <div className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-[#04102A] p-4 md:h-screen md:justify-end md:p-0 md:pr-16">
